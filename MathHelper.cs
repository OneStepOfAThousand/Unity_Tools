...
//This Script provides a variety of math functions to simplify writing code.
    ...
    public static readonly Vector2Int[] eightDirections =
{
    ...
    public static Texture2D MonocromeTexture(Color color)
    {
    ...
    {
        float percent = Mathf.Clamp01((value - currentMin)/ (value - currentMax));
    ...
    /// <summary>
    /// Returns an array of evenly spaced Vector3 points along an arc, with support for roation
    /// </summary>
